...
async function deleteApplication(postId: Number) {
  ...
  if (!response?.ok) {
    toast({
      ...
      description: "Your application was not deleted. Please try again.",
      variant: "destructive",
    })
  }
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={async (event) => {
                ...
                const deleted = await deleteApplication(application.job_id)
