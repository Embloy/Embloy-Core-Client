...
Anyone can report a vulnerability or security concern with a Embloy product by contacting [feedback@embloy.com](mailto:feedback@embloy.com) and including a proof of concept, a list of tools used (including versions), and the output of the tools. We take all disclosures very seriously, and once we receive a disclosure we rapidly verify each vulnerability before taking the necessary steps to fix it. Once verified, we periodically send status updates as problems are fixed.
