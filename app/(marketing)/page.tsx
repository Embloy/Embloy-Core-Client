...
export default async function IndexPage() {
  ...
  return (
    <>
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32 bg-background bg-[url('/images/bg-1-muted.png')] dark:bg-[url('/images/bg-1-muted-dark.png')] bg-cover bg-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          ...
          <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8 hidden sm:block">
      ...
      >
        ...
        <div className="relative overflow-hidden rounded-lg border bg-background p-2 transition-all duration-500 ease-in-out transform-gpu scale-100 opacity-90 hover:scale-105 hover:opacity-100">
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2 transition-all duration-500 ease-in-out transform-gpu scale-100 opacity-90 hover:scale-105 hover:opacity-100">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              <svg className="h-12 w-12 fill-currentColor" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section id="open-source" className="container py-8 md:py-12 lg:py-24">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          ...
          <div className="grid grid-cols-3 gap-4">
            <img className="transition-transform duration-400 ease-in-out transform hover:scale-110 rounded-xl" src="/images/mobile_button_page.png" alt="Description of Image 1" />
            <img className="transition-transform duration-400 ease-in-out transform hover:scale-110 rounded-xl" src="/images/banner-1.png" alt="Description of Image 2" />
            <img className="transition-transform duration-400 ease-in-out transform hover:scale-110 rounded-xl" src="/images/banner-1.png" alt="Description of Image 3" />
          </div>
        </div>
      </section>
      <section id="open-source" className="container py-8 md:py-12 lg:py-24">
