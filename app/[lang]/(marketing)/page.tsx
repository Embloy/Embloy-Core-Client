  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative scale-100 transform-gpu overflow-hidden rounded-lg border bg-background dark:bg-muted p-2 opacity-90 transition-all duration-500 ease-in-out hover:scale-105 hover:opacity-100">
      ...
      <section id="open-source" className="container bg-background bg-cover bg-center py-8 md:bg-[url('/images/bg-2.png')] md:py-12 md:dark:bg-[url('/images/bg-2a-dark.png')] lg:py-24">
